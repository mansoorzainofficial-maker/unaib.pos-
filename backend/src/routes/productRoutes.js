...
router.post('/', authRequired, adminOnly, prodCtrl.createProduct);
...
router.post('/meta/categories', authRequired, adminOnly, prodCtrl.createCategory);
router.get('/meta/suppliers', authRequired, prodCtrl.getSuppliers);
router.post('/meta/suppliers', authRequired, adminOnly, prodCtrl.createSupplier);
