...
export const translations = {
  ur: {
    ...
    extra_charges_label: 'اضافی رقم / سرچارج:',
    extra_charges_added: 'اضافی رقم / سرچارج شامل:',
  ...
  en: {
    ...
    extra_charges_label: 'Extra Charges / Surcharge:',
    extra_charges_added: 'Extra / Surcharge Added:',
