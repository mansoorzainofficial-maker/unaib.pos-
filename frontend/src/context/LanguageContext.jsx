...
export const translations = {
  ur: {
    ...
    customer_modal_title_new: 'نیا گاہک / پارٹی شامل کریں',
    customer_modal_title_edit: 'گاہک کی تفصیلات تبدیل کریں',
    customer_modal_sub: 'کاؤنٹر اور ادھار کھاتے کے لیے نیا گاہک رجسٹر کریں',
    customer_field_name: 'گاہک / پارٹی کا نام',
    customer_field_phone: 'موبائل / فون نمبر',
    customer_field_address: 'دکان / مارکیٹ کا پتہ',
    customer_field_opening_balance: 'پچھلا ادھار / اوپننگ بیلنس (Rs.)',
    customer_ph_name: 'مثلاً: حاجی عثمان الیکٹرانکس یا کاشف بھائی',
    customer_ph_phone: '0300-1234567',
    customer_ph_address: 'شاپ # 12، حفیظ سینٹر، لاہور',
    customer_ph_opening_balance: '0',
    customer_btn_cancel: 'منسوخ کریں',
    customer_btn_save_new: 'محفوظ کریں اور منتخب کریں',
    customer_saving: 'محفوظ ہو رہا ہے...',
    customer_err_name_required: 'گاہک کا نام لکھنا ضروری ہے۔',
    customer_created_success: 'نیا گاہک کامیابی سے رجسٹر ہو گیا۔',
    customer_quick_add: '+ نیا گاہک',
    ledger_add_party_btn: '+ نیا کھاتہ / پارٹی شامل کریں',
  ...
  en: {
    ...
    customer_modal_title_new: 'Register New Customer / Party',
    customer_modal_title_edit: 'Edit Customer Details',
    customer_modal_sub: 'Add customer for POS checkout and credit ledger',
    customer_field_name: 'Customer / Party Name',
    customer_field_phone: 'Phone Number',
    customer_field_address: 'Shop / Market Address',
    customer_field_opening_balance: 'Opening Balance / Previous Udhar (Rs.)',
    customer_ph_name: 'e.g. Haji Usman Electronics or Kashif Bhai',
    customer_ph_phone: '0300-1234567',
    customer_ph_address: 'Shop # 12, Hafeez Centre, Lahore',
    customer_ph_opening_balance: '0',
    customer_btn_cancel: 'Cancel',
    customer_btn_save_new: 'Save & Select',
    customer_saving: 'Saving...',
    customer_err_name_required: 'Customer name is required.',
    customer_created_success: 'Customer registered successfully.',
    customer_quick_add: '+ New Customer',
    ledger_add_party_btn: '+ Add New Party',
